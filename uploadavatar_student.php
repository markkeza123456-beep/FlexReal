...
// ชื่อไฟล์ = students/{user_id}.png (เขียนทับได้เลย ไม่สะสม)
...
// บันทึก URL ลงในตาราง student
try {
    $stmt = $conn->prepare("UPDATE public.students SET avatar_url = :url, updated_at = NOW() WHERE user_id = :uid");
