      ...
      <tr>
        ...
        <td>
          <div class="action-btns">
            <button type="button" class="btn-icon" data-edit-lesson="${lesson.id}" title="แก้ไขบทเรียน">แก้ไข</button>
            <button type="button" class="btn-icon danger" data-delete-lesson="${lesson.id}" title="ลบบทเรียน">ลบ</button>
          </div>
        </td>
      </tr>
    `).join('');
