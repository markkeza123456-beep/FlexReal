...
$seed = [
    ...
    ['กรุงศรีอยุธยาเป็นราชธานีของไทยนานประมาณกี่ปี?', '117 ปี', '220 ปี', '417 ปี', '500 ปี', 'A'],
    ['พ่อขุนรามคำแหงมหาราชทรงมีความสำคัญด้านใด?', 'การประดิษฐ์อักษรไทย', 'การสร้างรถไฟ', 'การตั้งกรุงเทพฯ', 'การเลิกทาส', 'A'],
    ['เหตุการณ์ใดเกิดขึ้นก่อนที่สุด?', 'ตั้งกรุงรัตนโกสินทร์', 'เสียกรุงศรีอยุธยาครั้งที่ 2', 'สุโขทัยเป็นราชธานี', 'เปลี่ยนแปลงการปกครอง', 'A'],
    ['ข้อใดคือหลักฐานทางประวัติศาสตร์ชั้นต้น?', 'หนังสือเรียนสังคม', 'ภาพยนตร์สารคดี', 'ศิลาจารึก', 'บทความสรุป', 'A'],
];
