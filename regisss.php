      ...
      <form class="form" id="regisForm" action="regisss_action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid-2">
          <div class="field" id="field-password">
            ...
            <div class="input-wrap">
              ...
              <input type="password" id="password" name="password" placeholder="อังกฤษ + ตัวเลข 8-15 ตัว" minlength="8" maxlength="15" pattern="(?=.*[A-Za-z])(?=.*[0-9])[A-Za-z0-9]{8,15}" autocomplete="new-password" />
          ...
          <div class="field" id="field-confirm">
            ...
            <div class="input-wrap">
              ...
              <input type="password" id="confirm" name="confirm" placeholder="กรอกรหัสผ่านอีกครั้ง" minlength="8" maxlength="15" pattern="(?=.*[A-Za-z])(?=.*[0-9])[A-Za-z0-9]{8,15}" autocomplete="new-password" />
        ...
        <div class="role-field parent-field" id="parent-link-section" style="display:none;">
          ...
          <div class="field" id="field-link-student-pin">
            <label class="label">PIN 6 หลักของนักเรียน<span class="required">*</span></label>
            <div class="pin-wrap" id="parentPinWrap">
              <input class="pin-digit" type="password" inputmode="numeric" maxlength="1" pattern="[0-9]" />
              <input class="pin-digit" type="password" inputmode="numeric" maxlength="1" pattern="[0-9]" />
              <input class="pin-digit" type="password" inputmode="numeric" maxlength="1" pattern="[0-9]" />
              <input class="pin-digit" type="password" inputmode="numeric" maxlength="1" pattern="[0-9]" />
            ...
            <input type="hidden" id="link_student_pin" name="link_student_pin" />
